...
source(paste0(app.path,'functions/gta_delta_input_query.R'))
source(paste0(app.path,'functions/gta_delta_rollback_input.R'))
source(paste0(app.path,'functions/gta_delta_resolve_discrepancy.R'))
